...
const CertificationBox = () => {
  const reversedData = [...certification].reverse();
      ...
      {reversedData.map((data) => {
        return (
          ...
          >
            ...
            <div className="h-[280px] w-[380px] hover:scale-125 transition duration-500 cursor-pointer shadow-xl rounded-[14px] overflow-hidden border-8 border-white sm:h-[260px] sm:w-[92%] sm:bg-cover mx-auto">
  <img
    src={data.img}
    alt={data.title}
              ...
              >
                ...
                <div className=" flex items-center justify-center gap-4">
                  ...
                  >
                    ...
                    <p className=" text-black">View Certification</p>
                  </Link>
                 
                </div>
              </div>
            </POPUP>
            <p className="text-center px-8 text-gray-800 text-xl font-medium sm:text-lg">
  {data.title}
</p>
          </div>
        );
